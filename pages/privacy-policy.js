      ...
      <Flex alignItems='center' justifyContent='center' mt='24' mb='14'>
        ...
        >
          <Text maxWidth='500px'>
            ...
            Effective date: 29 August 2025<Dbr />

            NamelessNanashi (&quot;Developer&quot;) operates this fork of the EasySave3 Editor web application (&quot;Application&quot;). This page informs you of our policies regarding the collection, use, and disclosure of personal information we receive from users of the Application.<Dbr />

            1. Information Collection and Use<br />
            This fork of The EasySave3 Editor Web Application does not collect or store any personal information from users. The Application operates locally on the user&apos;s device, and all uploaded data and modifications remain strictly on the user&apos;s device. No data is transmitted or stored externally.<Dbr />
            This fork uses Cloudflare Analytics on the domain level for anonymous usage statistics however does not require them to function, blocking &quot;cloudflareinsights.com&quot; will effectively disable analytics.<Dbr />
